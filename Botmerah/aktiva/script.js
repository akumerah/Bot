...
const botSay = (data) => {
  return[
    "halo, perkenalkan nama saya W8_0bot. Siapa nama kamu ?",
...
function finishing() {
  ...
  container[0].style.filter = "blur(8px)"
  setTimeout(() =>{
  pertanyaan.innerHTML = `Thank U ya ${usersData[0]} udah mampir ke w8_0bot, kali kali ajakin aku ${usersData[2]} bareng ya. 😉 `
 loaders.style.display = "none"
 container[0].style.filter = "none"
  }, [1500])
